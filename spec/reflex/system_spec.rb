...
describe Reflex::System do
  ...
  describe "list_methods" do
    before(:each) do
      FakeWeb.register_uri(:post, "http://social.react.com/XmlRpc/", :response => fake_response("System.listMethods"))   
    end
  ...
  describe "method_signature" do
    before(:each) do
      FakeWeb.register_uri(:post, "http://social.react.com/XmlRpc/", :response => fake_response("System.methodSignature"))   
    end
  ...
  describe "method_description" do
    before(:each) do
      FakeWeb.register_uri(:post, "http://social.react.com/XmlRpc/", :response => fake_response("System.methodDescription"))   
    end
